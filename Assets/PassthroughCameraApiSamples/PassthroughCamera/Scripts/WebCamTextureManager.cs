...
namespace PassthroughCameraSamples
{
    ...
    public class WebCamTextureManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Assert.AreEqual(
                1, FindObjectsByType<WebCamTextureManager>(FindObjectsInactive.Include, FindObjectsSortMode.None).Length,
        ...
        private void OnEnable()
        {
            ...
            {
                PCD.DebugMessage(
                    LogType.Log, "PCA: Passthrough Camera functionality is not supported by the current device." +
